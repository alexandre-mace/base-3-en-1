$(function () { // wait for document ready
  ...
  if (!isMobile) {
    ...
    var wipeAnimation = new TimelineMax()
      ...
      .fromTo(".numbers.two", 1, {right: "calc(-50vw + 50px)"}, {right: 50, ease: Linear.easeNone}, 1)
      .fromTo(".numbers__image.two", 1, {height: 100, width: 50, opacity: 0.25}, {height: 350, width: 172, opacity: 1, ease: Linear.easeNone}, 1)
      .fromTo(".numbers__reflect.two", 1, {height: 100, width: 50, opacity: 0}, {height: 350, width: 172, opacity: 1, ease: Linear.easeNone}, 1)
      ...
      .to(".numbers.twocheh", 1, {left: "-100px", right: 0, ease: Linear.easeNone}, 2)
      .to(".numbers__image.twocheh", 1, {height: 100, width: 50, opacity: 0.25, ease: Linear.easeNone}, 2)
      .to(".numbers__reflect.twocheh", 1, {height: 100, width: 50, opacity: 0, ease: Linear.easeNone}, 2)
      ...
      .fromTo(".numbers.three", 1, {right: "calc(-50vw + 50px)"}, {right: 50, ease: Linear.easeNone}, 3)
      .fromTo(".numbers__image.three", 1, {height: 100, width: 50, opacity: 0.25}, {height: 350, width: 172, opacity: 1, ease: Linear.easeNone}, 3)
      .fromTo(".numbers__reflect.three", 1, {height: 100, width: 50, opacity: 0}, {height: 350, width: 172, opacity: 1, ease: Linear.easeNone}, 3)
      // .fromTo(".arrow.three", 1, {opacity: 1}, {opacity: 0, ease: Linear.easeNone}, 0)
